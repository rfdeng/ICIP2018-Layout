...
%
As depicted in Fig.~\ref{fig:fcn-comparison}, depth and normals can serve as hint tending to merge big planes together under the interference factors like clutter and occlusion. 
%
...
%
While we consider the room layout as a high-level semantic information that rely more on global information, we modify the network by clipping the multi-scale related layers. 
...
\comments{We have also tried multi-task learning by adding a new branch for learning boundaries among surfaces as \cite{ren2016coarse, mallya2015learning} do. But the joint training does not help to improve the performance of both tasks in our case. This may indicate that our geometric hint have already integrated the additional information which should be learned through joint training.}
%
