...
%
While we consider the room layout as a high-level semantic information that relys more on global information, we modify the network by clipping the multi-scale related layers. 
